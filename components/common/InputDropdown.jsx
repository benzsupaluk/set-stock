  ...
  return (
    <>
      <Popover
        ...
        content={
          <ul className="flex flex-col gap-2 bg-white border border-gray-200 shadow-lg rounded-lg p-2 w-60 max-w-[calc(100dvw_-_200px)] text-sm">
      ...
      >
        <button
          ...
          aria-label="Option"
          title={selectedItem}
          className="rounded-lg text-sm sm:w-44 shadow-xs h-11 py-0.5 px-2.5 flex items-center gap-1 text-gray-600 font-semibold bg-white hover:bg-gray-50 border border-gray-300 disabled:border-gray-200 disabled:text-gray-400"
